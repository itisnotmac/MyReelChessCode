...
import { X, Wifi, Bot, Users, UsersRound, Crown } from 'lucide-react';

export default function PlayChessModal({ isOpen, onClose, onOnlinePvp, onVsAI, onLocalPvp, on2v2, isPremium }) {
  const modes = [
    {
      id: 'online',
      label: 'Online PVP',
