...
import { X, Users, Wifi, Monitor } from 'lucide-react';

export default function TwoVTwoModal({ isOpen, onClose, onLocal, onOnline, isAuthenticated }) {
  return (
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <div className="p-6 pb-10">
              ...
              <div className="space-y-3">
                ...
                <button
                  onClick={isAuthenticated ? onOnline : () => { onClose(); window.location.href = '/login'; }}
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-white/35 text-xs mt-0.5">
                      {isAuthenticated ? 'Create a room · Invite 3 friends with a code' : 'Sign in to play online'}
                    </p>
                  </div>
                </button>
              </div>
