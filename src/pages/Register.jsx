      ...
      <div className="w-full max-w-md bg-[#111118] border border-white/10 rounded-2xl p-8 shadow-2xl">
        {step === 'register' ? (
          <>
            ...
            <p className="text-white/50 text-center text-sm mb-8">Join Reel Chess today</p>
            ...
            <p className="text-white/40 text-sm text-center mt-6">
              ...
              <Link to="/login" className="text-white/70 hover:text-white transition">Sign in</Link>
            </p>
          </>
        ) : (
          <>
            <h1 className="text-2xl font-bold text-white text-center mb-2">Verify Email</h1>
            <p className="text-white/50 text-center text-sm mb-8">
              Enter the code sent to <span className="text-white/70">{email}</span>
            </p>
            ...
            <form onSubmit={handleVerify} className="space-y-4">
              ...
              <input
                ...
                required
                className="w-full bg-white/5 border border-white/10 text-white placeholder-white/30 rounded-lg px-4 py-2.5 focus:outline-none focus:border-white/30 transition text-center tracking-widest text-lg"
              />
              <button
                type="submit"
                disabled={loading}
            ...
            <p className="text-white/40 text-sm text-center mt-4">
              Didn't receive it?{' '}
              <button onClick={handleResend} className="text-white/70 hover:text-white transition">Resend code</button>
            </p>
          </>
        )}
      </div>
