...
const FAQS = [
  ...
  { q: "What does Premium include?", a: "A Premium subscription unlocks Online PVP (matchmaking against players worldwide) and 2v2 Team Mode. It does not include cosmetic items — all board skins and piece sets are currently free for everyone." },
  ...
  { q: "How do tournaments work?", a: "Tournaments are bracket-style competitions with a Tempo buy-in. Once enough players register, the bracket is seeded and you advance by winning games. Prize pools are distributed to top finishers based on the tournament's prize structure." },
  { q: "Can I play in 3D?", a: "Yes! You can toggle 3D mode in Settings. The 3D board renders with Three.js, giving you an immersive, tilted perspective of the board and pieces. You can still rotate and interact the same way as 2D." },
